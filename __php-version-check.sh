...
if [ $? -eq 0 ]
then
  echo -e "\n8.1     php CLI: PHP "$("$php_prefix"/php/8.1/nts/bin/php -r 'echo PHP_VERSION;')
...
if [ $? -eq 0 ]
then
  echo -e "\n8.1     php CLI: PHP "$("$php_prefix"/php/8.1/zts/bin/php -r 'echo PHP_VERSION;')
...
if [ $? -eq 0 ]
then
  echo -e "\n8.2     php CLI: PHP "$("$php_prefix"/php/8.2/nts/bin/php -r 'echo PHP_VERSION;')
...
if [ $? -eq 0 ]
then
  echo -e "\n8.2     php CLI: PHP "$("$php_prefix"/php/8.2/zts/bin/php -r 'echo PHP_VERSION;')
...
if [ $? -eq 0 ]
then
  echo -e "\n8.3     php CLI: PHP "$("$php_prefix"/php/8.3/nts/bin/php -r 'echo PHP_VERSION;')
...
if [ $? -eq 0 ]
then
  echo -e "\n8.3     php CLI: PHP "$("$php_prefix"/php/8.3/zts/bin/php -r 'echo PHP_VERSION;')
...
if [ $? -eq 0 ]
then
  echo -e "\n8.4     php CLI: PHP "$("$php_prefix"/php/8.4nts//bin/php -r 'echo PHP_VERSION;')
...
if [ $? -eq 0 ]
then
  echo -e "\n8.4     php CLI: PHP "$("$php_prefix"/php/8.4/zts/bin/php -r 'echo PHP_VERSION;')
